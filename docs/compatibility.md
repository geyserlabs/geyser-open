...
| Developer API 2026-08-24 | yes | [public HTTPS OpenAPI](https://agents.geyserlabs.ai/api/v1/openapi.json) | Protected contract/source gates and live unauthenticated-denial probe passed; positive independent-developer sandbox gate pending | Developer Preview routes yes; GA no | Global and customer-1 managed Cell at Coordinator source `ee341285efa1a067555c83be2130926f755f41e9` / image `sha256:e275d5e58f6c256ecd7bf3acac600b04c10e8e25f7468888b605dbd04e84b297` |
...
| Homebrew formula 0.1.0b4 | yes | `geyserlabs/homebrew-tap` | Apple-Silicon public tap install, test, and audit passed; native Ubuntu AMD64 formula generation and integrity gates passed | no | no |
...
authentication; they do not substitute for the independent non-implementer gate described in
[Independent developer preview gate](external-preview.md).
